...
// Bonus Types
export const bonusTypeSchema = z.enum(['PERFORMANCE', 'HOLIDAY', 'OVERTIME', 'REFERRAL', 'LOYALTY', 'OTHER']);
export const bonusStatusSchema = z.enum(['PENDING', 'APPROVED', 'PAID', 'CANCELLED']);
...
// User Types
export const userRoleSchema = z.enum(['SUPER_ADMIN', 'HR_MANAGER', 'PAYROLL_MANAGER', 'DEPARTMENT_MANAGER', 'EMPLOYEE']);
